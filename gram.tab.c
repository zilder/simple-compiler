...
static const char *const yytname[] =
{
  ...
  "TCEQ", "TCNE", "TCLT", "TCLE", "TCGT", "TCGE", "TEQUAL", "$accept",
  "program", "stmts", "stmt", "var_decl", "ident", 0
};
#endif
...
#line 39 "gram.y"
  ...
  case 6:
#line 45 "gram.y"
    { (yyval.stmt) = new VarDecl((yyvsp[(1) - (2)].ident), (yyvsp[(2) - (2)].ident)); ;}
    break;

  case 7:
#line 48 "gram.y"
    { (yyval.ident) = new Ident(*(yyvsp[(1) - (1)].string)); delete (yyvsp[(1) - (1)].string); ;}
    break;


/* Line 1267 of yacc.c.  */
#line 1360 "gram.tab.c"
      default: break;
    }
